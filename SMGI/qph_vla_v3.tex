...
\begin{figure*}[!tb]
\epsscale{1.18}
\plotone{/Users/fu/casa/15a266/figs/vla_detect.eps}
...
\caption{Absorption line velocity profiles for \lya, \CII\,$\lambda$1335, and \SiIV\,$\lambda\lambda$1394,1403. The Keck/LRIS spectra of the background QSOs have been normalized by a model of the QSO continuum. All panels show the region $\pm$3000~\kms\ around the systemic redshifts of the SMGs. The top panels show Gaussian fits to the \lya\ absorption line. The vertical dashed line shows the centroid velocity.
\label{fig:abs}} 
\end{figure*}
