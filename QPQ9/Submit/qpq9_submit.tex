...
skewed toward positive velocities. We have 30 pairs in the QPQ9 sample for \ion{C}{2} analysis
...
to the data, we measure the centroid of the \ion{C}{2} stack to be $+254\,{\rm km\,s^{-1}}$ and 
...
for the \ion{C}{2} mean stack. 99\% of the centroids are positively offset from $z_{\rm fg}$.}
...
$\sigma_{\rm intrinsic}^{\rm full}=243\,{\rm km\,s^{-1}}$. For the sub-sample with [\ion{O}{3}] 
...
the stack of the sub-sample with [\ion{O}{3}] redshifts. We also test for the 
