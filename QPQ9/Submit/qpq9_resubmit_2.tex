...
{\bf One may ask whether absorption from \ion{C}{2*}\,1335 may bias the measurement of the
...
from \ion{C}{2*}\,1335 is not blended with \ion{C}{2}\,1334. Among these nine subsystems, only one,
labeled J1420+1603F in QPQ8, has a \ion{C}{2*}\,1335 equivalent width comparable to \ion{C}{2}\,1334.
Hence, contamination from \ion{C}{2*}\,1335 is insignificant and could not be responsible for the
...
\ion{C}{2} mean absorption may be reproduced within modeling errors.}
