...
redshift.
{\bf From a sample of 7 \ion{C}{2} systems and 10 \ion{C}{4}
...
{\bf dispersion and the centroid of the \ion{C}{2} mean stack are $27\,{\rm km\,s^{-1}}$ and
...
{\bf Their mean \ion{C}{2} to \ion{C}{2*} equivalent width ratio is 0.2.}
...
{\bf We simulate that absorption from \ion{C}{2*} may only bias the \ion{C}{2} centroid by
$\approx+40\,{\rm km\,s^{-1}}$.}
...
observed centroid and intrinsic dispersion of the mean absorption by \ion{C}{2}.}
...
this asymmetry in \ion{H}{1} (J.\ F.\ Hennawi et al.\ {\bf 2018}, in preparation). In conclusion, we
