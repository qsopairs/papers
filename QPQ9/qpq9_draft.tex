...
$\sigma_v>300\,{\rm km\,s^{-1}}$. We show that, gas in gravitational motion, Hubble flow, or 
galactic-scale outflows are all consistent with the observed widths. Furthermore, we find that the 
mean absorptions are asymmetric about the systemic redshift. The mean absorption centroids exhibit 
small redshift relative to the systemic $\delta v\approx+200\,{\rm km\,s^{-1}}$, with large 
intrinsic scatter in the centroid velocities of the individual absorption systems. We show 
that the observed offsets may be produced by anisotropic or intermittent ionizing radiation from 
the foreground quasars. 
\end{abstract}
...
absorption profile with $\sigma_v=654\,{\rm km\,s^{-1}}$, that is ruled out. Motions that produce 
this width are ruled out at $3\sigma$ confidence by bootstrap analysis on the observational data. 
}
\label{fig:monte}
\end{figure}
...
$10^{12.6}\,M_\odot$ respectively. If QPQ dark matter halos have a characteristic mass 
$10^{12.5}\,M_\odot$ and follow an NFW profile \citep{NavarroFrenkWhite97} with concentration 
parameter $c=4$, at $z\approx2$ the maximum circular velocity is $319\,{\rm km\,s^{-1}}$. 
According to \cite{Tormen97}, the maximum circular velocity is $\approx1.4$ times larger than the 
one-dimensional velocity dispersion $\sigma_{\rm 1D}$. Hence, the line-of-sight velocity 
dispersion typical of QPQ halos is $\sigma_{\rm 1D}=228\,{\rm km\,s^{-1}}$. We can investigate 
...
The resulting stack of mock spectra has a $1\sigma$ dispersion of $263\,{\rm km\,s^{-1}}$. This is 
...
the observed dispersion, a width of $\sigma_v>654\,{\rm km\,s^{-1}}$ is ruled out at 3$\sigma$ 
confidence (overplotted in Figure~\ref{fig:monte}). In other words, motions additional to 
gravitational and Hubble flows that will produce intrinsic dispersion 
$\sigma_v>628\,{\rm km\,s^{-1}}$ are ruled out. 

On the contrary, $\sigma_{\rm 1D}<175\,{\rm km\,s^{-1}}$ together with Hubble velocities will 
result in a velocity width that is more than three times the modeling error away from the observed 
intrinsic width. This implies that if the characteristic dark matter halo mass 
$<10^{12.2}\,M_\odot$, additional dynamical processes are required to explain the observed width.  
...
explanations will require the gas to be either outflowing or in Hubble flow. Were the gas 
inflowing instead, the velocity centroid would be negative. 
